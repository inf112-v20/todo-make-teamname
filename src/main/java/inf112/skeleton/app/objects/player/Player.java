...
public class Player {
    ...
    private boolean readyButtonPuhed = false;
    ...
    public boolean getPushedReady() {
        return this.readyButtonPuhed;
    }
    public void setPushedReady(boolean b){
        this.readyButtonPuhed = b;
    }
}
